...
//update present status of item in db
...
//delete all item of user if it is not currently present in his/her wishlist
...
// post request to send message of price drop items
  ...
  function mail(email,items)
  {
    ...
    var transporter = nodemailer.createTransport(smtpTransport({
        ...
        host: 'smtp.gmail.com',
        auth: {
          user: 'rijibasuma@gmail.com',
          pass: 'ougsxhikluqsndlt'
        }
      }));
      
      var mailOptions = {
        from: 'rijibasuma@gmail.com',
        to: email,
