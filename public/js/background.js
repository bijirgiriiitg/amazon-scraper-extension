...
chrome.runtime.onMessage.addListener((msg, sender, sendResponse) => {
    if(msg.type=="isloggedin"){
        console.log("login running in background.js");
    ...
    if(msg.type=="Scrap"){
        console.log("Scrape running in background.js");
        chrome.tabs.create({
...
//receiving dropped product list from content.js and sending to "/product/message" server
